...
class Generator(nn.Module):
    def __init__(self, params):
        ...
        self.main = nn.Sequential(
            ...
            nn.ConvTranspose3d(nz, ngf * 16, (4,1,4), 1, 0, bias=False),
            ...
            nn.ConvTranspose3d(ngf * 8, ngf * 4, (4,6,4), 2, 1, bias=False),
            nn.BatchNorm3d(ngf * 4),
            nn.ReLU(True),
            # state size. (ngf*4) x 16 x 16 
            nn.ConvTranspose3d(ngf * 4, ngf * 2, (4,5,4), 2, 1, bias=False),
...
class Discriminator(nn.Module):
    def __init__(self, params):
        ...
        self.main = nn.Sequential(
            ...
            nn.Conv3d(ndf * 16, 1, (4,1,4), stride=1, padding=0, bias=False),
            # state size. 1
        )
